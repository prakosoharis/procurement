...
export const Permission = Object.freeze({
  ...
  PEOPLE_STRUCTURE_MANAGE: 'people.structure.manage',
  PEOPLE_PROFILE_MANAGE: 'people.profile.manage',
  PEOPLE_ASSIGNMENT_MANAGE: 'people.assignment.manage',
...
const policy = Object.freeze({
  ...
  [Permission.PEOPLE_VIEW]: [Role.SUPERUSER, Role.PROCUREMENT_TEAM, Role.BUSINESS_UNIT],
  [Permission.PEOPLE_STRUCTURE_MANAGE]: governanceRoles,
  [Permission.PEOPLE_PROFILE_MANAGE]: governanceRoles,
  [Permission.PEOPLE_ASSIGNMENT_MANAGE]: governanceRoles,
