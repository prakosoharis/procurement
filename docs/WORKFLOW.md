...
| Storage | `lib/storage.js` abstracts S3-compatible storage and Google Drive. Google Drive is supported through `lib/google-drive.js`. | Reuse for original source PDFs, SOP files, attachments, and evidence files. |
