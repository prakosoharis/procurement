...
M2-C6-T1 must select and document the final migration. The recommended shape is
...
1. **M2-C6-T1** — Reconcile the conversion data contract and schema; resolve
   the decision-required items below before product code.
