...
export async function POST(request){
  ...
  if(requestType==='EXCEPTION'&&!['BU_PIC','SUPER_USER'].includes(user.role))return NextResponse.json({error:'Request for Exception hanya dapat diajukan oleh Business Unit.'},{status:403});
